...
class flood_model:
    ...
    def computeImpactCost(self, zones, parcel_field, bfield, lfield, impact_point, bloss_fun, lloss_fun):
        ...
        try:
            ...
            self.file.add_column('Impact_Building_Val', impacted_building_value)
            self.file.add_column("Impacted_Land_Val", impacted_land_value)
            self.file.add_column("Impacted_Total_Val", impacted_total_value)
